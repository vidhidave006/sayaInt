      ...
      <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-6">
        ...
        <div className="flex flex-wrap items-center justify-center gap-4 pt-4">
          ...
          <a
            ...
            className="inline-flex items-center gap-2 bg-emerald-600 hover:bg-emerald-700 text-white px-7 py-3.5 rounded-full font-semibold text-base shadow-xl shadow-emerald-600/25 hover:-translate-y-0.5 transition-all duration-300 cursor-pointer"
          >
          ...
          {showPhone && (
            <a
              ...
              className="inline-flex items-center gap-2 bg-white/10 hover:bg-white/20 text-white border border-white/20 hover:border-white/40 px-6 py-3.5 rounded-full font-semibold text-base backdrop-blur-xs hover:-translate-y-0.5 transition-all duration-300 cursor-pointer"
            >
