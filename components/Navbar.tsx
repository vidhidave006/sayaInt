      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between">
          ...
          <div className="hidden lg:flex items-center space-x-3">
            <a
              href="tel:+918983689836"
              className="flex items-center gap-2 text-slate-700 hover:text-sky-600 px-3 py-2 text-sm font-medium transition-colors duration-200"
            >
            ...
            <Link
              href="/contact"
              className="inline-flex items-center gap-2 bg-sky-500 hover:bg-sky-600 text-white px-5 py-2.5 rounded-full text-sm font-semibold shadow-sm hover:shadow-md transition-all duration-200"
            >
